...
function rollDiceBtnClickEvent() {
    ...
    //3 players outcome
    if (reset == 2) { window.location.reload(false); } else {
        reset++;
        ...
        if (reset != 0 && outcome != "It's a draw!!") {
            ...
            document.querySelector(".confetti").classList.add("visible"); //replace toggle with add/remove
        }

        document.querySelector(".rollbutton").innerHTML = "Let roll again";
        reset++;
    }
